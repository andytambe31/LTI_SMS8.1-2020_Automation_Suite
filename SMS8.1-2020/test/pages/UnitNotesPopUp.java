...
public class UnitNotesPopUp {
	...
	//Grid
	By noteInGrid = By.id("divgrdUnitNote");
	
	public UnitNotesPopUp(WebDriver driver) {
		this.driver = driver;
	...
	public void setNote(String note) {
		...
		//js.executeScript("arguments[0].value='"+note+"';", driver.findElement(noteTextBox));
	}
	
	public void waitForNoteToBeAdded() {
		utlFn.waitForDetailsToLoad(driver.findElement(noteInGrid), "text");
	}
